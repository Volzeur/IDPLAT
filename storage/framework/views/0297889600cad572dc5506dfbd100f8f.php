...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="<?php echo e(asset('favicon.png')); ?>">
        ...
        <main class="max-w-[1440px] mx-auto px-4 py-4">
            ...
            <?php if(session('success')): ?>
                <div class="clay p-3 mb-4 flex items-center gap-3 accent-steel">
                    ...
                    <p class="text-primary text-sm"><?php echo e(session('success')); ?></p>
                </div>
            <?php endif; ?>
            <?php if(session('refresh_error')): ?>
                <div class="clay p-3 mb-4 flex items-center gap-3 accent-slate">
                    <i class="fas fa-circle-exclamation text-muted text-sm"></i>
                    <p class="text-primary text-sm"><?php echo e(session('refresh_error')); ?></p>
                </div>
            <?php endif; ?>
            <?php if($loadError): ?>
                <div class="clay p-3 mb-4 flex items-center gap-3 accent-slate">
                    <i class="fas fa-triangle-exclamation text-muted text-sm"></i>
                    <p class="text-primary text-sm">Gagal memuat data: <?php echo e($loadError); ?></p>
                </div>
            <?php endif; ?>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-5">
                ...
                <div class="lg:col-span-5 space-y-5">
                    ...
                    <div class="clay-strong p-6">
                        ...
                        <form action="<?php echo e(route('vehicle-plate.check')); ?>" method="POST" class="space-y-4">
                            <?php echo csrf_field(); ?>
                            <div class="clay-inset p-1">
                                <div class="relative">
                                    ...
                                    <input
                                        type="text"
                                        name="plate_number"
                                        value="<?php echo e(old('plate_number', $input)); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                            <div class="mt-3 flex items-center gap-2">
                                ...
                                <p class="text-secondary text-xs"><?php echo e($message); ?></p>
                            </div>
                        <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-5 pt-4 border-t border-gray-500/20">
                            <div class="flex items-center gap-2 flex-wrap">
                                ...
                                <?php $__currentLoopData = ['B', 'DK', 'B 1174 KKB', 'AB 1234 CD']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $example): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <span class=" text-secondary text-[11px] clay-subtle px-2.5 py-1 rounded-lg"><?php echo e($example); ?></span>
                    ...
                    <?php if($error): ?>
                        <div class="clay p-4 flex items-center gap-3 accent-slate">
                            ...
                            <p class="text-primary text-sm font-medium"><?php echo e($error); ?></p>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if($result): ?>
                        <div class="clay-strong p-6 space-y-4">
                            ...
                            <?php if($result['detailed_city']): ?>
                                <div class="clay-inset p-4 accent-navy">
                                    <span class="clay-pill mb-3">
                                        <i class="fas fa-location-dot"></i> Kota
                                    </span>
                                    <p class="text-primary text-lg font-bold"><?php echo e($result['detailed_city']); ?></p>
                                </div>
                            <?php elseif($result['is_full_plate']): ?>
                            ...
                            <?php else: ?>
                                <div class="clay-inset p-3 flex items-center gap-2.5 accent-steel">
                                    <p class="text-secondary text-xs">
                                        Masukkan plat lengkap (contoh: <span class=" text-primary font-semibold"><?php echo e($result['plate_code']); ?> 1234 ABC</span>) untuk detail kota.
                                    </p>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="grid grid-cols-2 gap-3">
                                <div class="clay-inset p-4 accent-steel">
                                    ...
                                    <p class="text-primary text-base font-bold"><?php echo e($result['region']); ?></p>
                                </div>
                                <div class="clay-inset p-4 accent-steel">
                                    <span class="clay-pill mb-3">
                                        <i class="fas fa-earth-asia"></i> Provinsi
                                    </span>
                                    <p class="text-primary text-base font-bold"><?php echo e($result['province']); ?></p>
                                </div>
                            </div>

                            
                            <?php if($result['cities'] && !$result['detailed_city']): ?>
                                <div class="clay-inset p-4 accent-slate">
                                    ...
                                    <p class="text-secondary text-sm leading-relaxed"><?php echo e($result['cities']); ?></p>
                                </div>
                            <?php endif; ?>
                    ...
                    <?php if(count($allCodes) > 0): ?>
                        <div class="clay-strong p-6 flex flex-col h-full max-h-[810px]">
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-3 mb-4 shrink-0">
                                <div class="flex items-center gap-2.5">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-muted text-[10px] tracking-wider font-medium">
                                            <?php echo e(count($allCodes)); ?> KODE TERDAFTAR
                                ...
                                <form action="<?php echo e(route('vehicle-plate.refresh')); ?>" method="POST"
                            ...
                            <div class="clay-inset overflow-y-auto overflow-x-auto flex-1 w-full">
                                <table class="w-full text-left border-collapse min-w-[600px]">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $allCodes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $plate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr class="table-row-clay cursor-pointer"
                                                onclick="document.querySelector('input[name=plate_number]').value='<?php echo e($plate['plate_code']); ?>'; document.querySelector('form[action=\'<?php echo e(route('vehicle-plate.check')); ?>\']').submit();">
                                                <td class="py-2.5 px-4">
                                                    <span class=" font-bold text-[11px] badge-clay-sm inline-block px-3 py-1 rounded-lg"><?php echo e($plate['plate_code']); ?></span>
                                                </td>
                                                <td class="py-2.5 px-4 text-primary font-semibold text-sm whitespace-nowrap"><?php echo e($plate['region']); ?></td>
                                                <td class="py-2.5 px-4 text-secondary text-sm whitespace-nowrap"><?php echo e($plate['province']); ?></td>
                                                
                                                <td class="py-2.5 px-4 text-muted text-xs whitespace-nowrap"><?php echo e(\Illuminate\Support\Str::limit($plate['cities'] ?? '', 45)); ?></td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
                                </table>
...
</html><?php /**PATH C:\laragon\www\idplate\resources\views/vehicle-plate/index.blade.php ENDPATH**/ ?>